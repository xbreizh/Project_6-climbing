...
<s:if test="!#session.user ">
    ...
    <s:form action="member_new" method="POST">
        ...
        <s:textfield label="Password" type="password" name="member.password" placeholder="Password"
                     requiredLabel="true"/>
        ...
        <s:textfield label="Repeat Email" type="email" name="emailCheck" placeholder="Repeat Email"
                     requiredLabel="true"/>
...
<s:else>
    ...
    <img alt="Access forbidden!" style=" max-width: 50%; height: auto;"
         src=" https://previews.123rf.com/images/corund/corund1511/corund151100022/48297160-access-denied-sign-clipping-path-included.jpg">
