...
Role: <s:property value="%{member.role}"/><br><br>
    ...
    <s:form action="member_update" method="POST">
        ...
        <s:textfield label="Password" type="password" name="password" placeholder="Password"  value="******" requiredLabel="true"/>
        <s:textfield label="Repeat Password" type="password" name="passwordCheck" placeholder="Repeat Password"
                     value="******"  requiredLabel="true"/>
        <s:textfield label="Email" type="email" name="member.email" value="%{member.email}"  placeholder="Email" requiredLabel="true"/>
