...
-- Started on 2018-12-08 15:44:08
...
SET SESSION AUTHORIZATION 'ocp';

DROP DATABASE "ClimbingWorld";
--
-- TOC entry 2887 (class 1262 OID 57986)
-- Name: ClimbingWorld; Type: DATABASE; Schema: -; Owner: ocp
--

CREATE DATABASE "ClimbingWorld" WITH TEMPLATE = template0 ENCODING = 'UTF8' LC_COLLATE = 'English_United Kingdom.1252' LC_CTYPE = 'English_United Kingdom.1252';


\connect "ClimbingWorld"
...
--
-- TOC entry 197 (class 1259 OID 57989)
-- Name: booking; Type: TABLE; Schema: public; Owner: ocp
--
